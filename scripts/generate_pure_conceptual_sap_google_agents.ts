  ...
  <diagram id="pure_conceptual_sap_agents" name="Conceptual Architecture: Holistic SAP Multi-Agent AI on Google Cloud">
    <mxGraphModel dx="1840" dy="1040" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="1840" pageHeight="1040" background="#FFFFFF" math="0" shadow="0">
      <root>
        ...
        <mxCell id="hdr_sub" value="Executive Conceptual Blueprint: Autonomous Enterprise Agents, Interoperability Protocols (A2A / MCP / REST / Zero-Copy), and Unified Systems of Record." style="text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;whiteSpace=wrap;rounded=0;fontFamily=Google Sans, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, sans-serif;fontSize=11;fontStyle=0;fontColor=#64748B;" vertex="1" parent="1">
        ...
        <!-- Step 1 Card -->
        <mxCell id="sc_card_1" value="Flow 1: User Request &amp; Intent Dispatch&lt;br&gt;&lt;span style=&quot;font-size: 8.5px; font-weight: normal; color: #475569;&quot;&gt;Natural language inquiry routed to No-Code assistant or Pro-Code agent&lt;/span&gt;" style="rounded=1;arcSize=6;fillColor=#FFFFFF;strokeColor=#CBD5E1;strokeWidth=1;html=1;whiteSpace=wrap;fontFamily=Google Sans, sans-serif;fontSize=10;fontStyle=1;fontColor=#0F172A;align=left;verticalAlign=middle;spacingLeft=14;" vertex="1" parent="1">
        ...
        <!-- Step 2 Card -->
        <mxCell id="sc_card_2" value="Flow 2: A2A Collaboration &amp; Dynamic MCP Tools&lt;br&gt;&lt;span style=&quot;font-size: 8.5px; font-weight: normal; color: #475569;&quot;&gt;Pro-Code agent negotiates with SAP Joule (A2A) and invokes MCP tools&lt;/span&gt;" style="rounded=1;arcSize=6;fillColor=#FFFFFF;strokeColor=#CBD5E1;strokeWidth=1;html=1;whiteSpace=wrap;fontFamily=Google Sans, sans-serif;fontSize=10;fontStyle=1;fontColor=#0F172A;align=left;verticalAlign=middle;spacingLeft=14;" vertex="1" parent="1">
        ...
        <!-- Step 3 Card -->
        <mxCell id="sc_card_3" value="Flow 3: Zero-Copy Analytics &amp; Cortex Grounding&lt;br&gt;&lt;span style=&quot;font-size: 8.5px; font-weight: normal; color: #475569;&quot;&gt;BigQuery and SAP Datasphere share telemetry via Zero-Copy federation&lt;/span&gt;" style="rounded=1;arcSize=6;fillColor=#FFFFFF;strokeColor=#CBD5E1;strokeWidth=1;html=1;whiteSpace=wrap;fontFamily=Google Sans, sans-serif;fontSize=10;fontStyle=1;fontColor=#0F172A;align=left;verticalAlign=middle;spacingLeft=14;" vertex="1" parent="1">
        ...
        <!-- Step 4 Card -->
        <mxCell id="sc_card_4" value="Flow 4: Action Execution &amp; Core ERP Settlement&lt;br&gt;&lt;span style=&quot;font-size: 8.5px; font-weight: normal; color: #475569;&quot;&gt;Validated transactions executed on SAP S/4HANA core and verified in audit log&lt;/span&gt;" style="rounded=1;arcSize=6;fillColor=#FFFFFF;strokeColor=#CBD5E1;strokeWidth=1;html=1;whiteSpace=wrap;fontFamily=Google Sans, sans-serif;fontSize=10;fontStyle=1;fontColor=#0F172A;align=left;verticalAlign=middle;spacingLeft=14;" vertex="1" parent="1">
