  ...
  <diagram id="gcp_serverless_app" name="GCP Serverless Web Application">
    <mxGraphModel dx="1600" dy="900" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageEnabled="0" pageScale="1" pageWidth="1600" pageHeight="1000" math="0" shadow="0">
      <root>
        ...
        <!-- COLUMN 1: INGRESS & SECURITY (X: 100) -->
        ...
        <!-- COLUMN 2: SERVERLESS COMPUTE TIERS (X: 560) -->
        ...
        <!-- COLUMN 3: PRIVATE STORAGE & DATABASE (X: 1020) -->
        ...
        <!-- ORTHOGONAL CONNECTORS WITH WHITE BACKGROUND PILLS -->
  ...
  <diagram id="gcp_streaming_pipeline" name="GCP Real-Time Streaming Analytics & Telemetry">
    <mxGraphModel dx="1600" dy="900" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageEnabled="0" pageScale="1" pageWidth="1600" pageHeight="1000" math="0" shadow="0">
      <root>
        ...
        <!-- COLUMN 1: CLIENT & GATEWAY INGRESS (X: 100, Y: 100) -->
        ...
        <!-- COLUMN 2: SECURITY, ORDER ORCHESTRATION & WAREHOUSE (X: 560) -->
        ...
        <!-- COLUMN 3: LOGISTICS SYNC & AUDIT LEDGER (X: 1020) -->
        ...
        <!-- ORTHOGONAL COLLISION-FREE ROUTING CONNECTORS WITH WHITE MASK BACKGROUND PILLS -->
        <!-- 1. Customer App -> Cloudflare WAF -->
        ...
        <!-- 2. Cloudflare WAF -> Order Fulfillment Service -->
        ...
        <!-- 3. Order Fulfillment -> Stripe Payment (Top Channel y=300) -->
        ...
        <!-- 4. Stripe Payment -> Order Fulfillment Reply (Bottom Channel y=335) -->
        ...
        <!-- 5. Order Fulfillment -> Kafka Event Stream (Dedicated Left Channel x=500) -->
        ...
        <!-- 6. Kafka Event Stream -> Inventory Warehouse Service (Top Channel y=480) -->
        ...
        <!-- 7. Inventory Warehouse -> Kafka Reply (Bottom Channel y=515) -->
        ...
        <!-- 8. Order Fulfillment -> PostgreSQL Order DB -->
        ...
        <!-- 9. Order Fulfillment -> FedEx Logistics Sync -->
        ...
        <!-- 10. FedEx Logistics -> Order Fulfillment Reply -->
        ...
        <!-- 11. Inventory Warehouse -> Redis Stock Cache -->
        ...
        <!-- 12. Kafka Event Stream -> Automated Audit Trail Ledger -->
