...
export function getExactErdReferenceXml(): string {
  ...
  tables += createTable('dim_pat', '<b>[DIM] Dim_Patient</b>', 50, 280, 190, 120, '<b>PK</b> Patient Key<br>&nbsp;&nbsp;&nbsp;&nbsp;Patient Type<br>&nbsp;&nbsp;&nbsp;&nbsp;Region<br>&nbsp;&nbsp;&nbsp;&nbsp;Age Group<br>&nbsp;&nbsp;&nbsp;&nbsp;Demographics<br>&nbsp;&nbsp;&nbsp;&nbsp;Disease History', '#DBEAFE', '#1E3A8A');
  tables += createTable('dim_phy', '<b>[DIM] Dim_Physician</b>', 50, 430, 190, 110, '<b>PK</b> Physician Key<br>&nbsp;&nbsp;&nbsp;&nbsp;Specialization<br>&nbsp;&nbsp;&nbsp;&nbsp;Affiliation<br>&nbsp;&nbsp;&nbsp;&nbsp;Ranking<br>&nbsp;&nbsp;&nbsp;&nbsp;Location', '#DBEAFE', '#1E3A8A');
  tables += createTable('dim_prod', '<b>[DIM] Dim_Oncology_Product</b>', 50, 570, 190, 110, '<b>PK</b> Product Key<br>&nbsp;&nbsp;&nbsp;&nbsp;Product Name<br>&nbsp;&nbsp;&nbsp;&nbsp;Therapy Area<br>&nbsp;&nbsp;&nbsp;&nbsp;Status<br>&nbsp;&nbsp;&nbsp;&nbsp;Competing Products', '#DBEAFE', '#1E3A8A');
  ...
  tables += createTable('fact_ins', '<b>[FACT] Fact_Oncology_Insights</b>', 370, 280, 220, 130, '<b>PK</b> Patient ID<br>&nbsp;&nbsp;&nbsp;&nbsp;Product ID<br>&nbsp;&nbsp;&nbsp;&nbsp;Date ID<br>&nbsp;&nbsp;&nbsp;&nbsp;Silo ID<br>&nbsp;&nbsp;&nbsp;&nbsp;Value Metric<br>&nbsp;&nbsp;&nbsp;&nbsp;Confidence Score<br>&nbsp;&nbsp;&nbsp;&nbsp;Confidence Interval', '#E0F2FE', '#0369A1');
  tables += createTable('fact_enc', '<b>[FACT] Fact_Patient_Encounters</b>', 370, 450, 220, 140, '<b>PK</b> Patient ID<br>&nbsp;&nbsp;&nbsp;&nbsp;Encounter ID<br>&nbsp;&nbsp;&nbsp;&nbsp;Date ID<br>&nbsp;&nbsp;&nbsp;&nbsp;Diagnosis ID<br>&nbsp;&nbsp;&nbsp;&nbsp;Physician ID<br>&nbsp;&nbsp;&nbsp;&nbsp;Payer ID<br>&nbsp;&nbsp;&nbsp;&nbsp;Value Metric', '#E0F2FE', '#0369A1');
  ...
  tables += createTable('dim_payer', '<b>[DIM] Dim_Payer</b>', 820, 580, 180, 100, '<b>PK</b> Payer Key<br>&nbsp;&nbsp;&nbsp;&nbsp;Payer Name<br>&nbsp;&nbsp;&nbsp;&nbsp;Type<br>&nbsp;&nbsp;&nbsp;&nbsp;Tier', '#DBEAFE', '#1E3A8A');
  ...
  tables += createTable('ml_inf', '<b>[ML] ML_Inference_Log</b>', 1210, 560, 220, 155, '<b>PK</b> Inference Key<br>&nbsp;&nbsp;&nbsp;&nbsp;Model Used<br>&nbsp;&nbsp;&nbsp;&nbsp;Input Keys (Patient/Product)<br>&nbsp;&nbsp;&nbsp;&nbsp;Output Prediction<br>&nbsp;&nbsp;&nbsp;&nbsp;Probability Score<br>&nbsp;&nbsp;&nbsp;&nbsp;Actual Truth Label<br>&nbsp;&nbsp;&nbsp;&nbsp;Timestamp', '#D1FAE5', '#065F46');
