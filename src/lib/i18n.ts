...
export const TRANSLATIONS: Record<SupportedLanguage, Record<string, string>> = {
  ...
  es: {
    ...
    refineHint: 'Presiona Enter para enviar. Gemini 3.7 Flash refinará tu diagrama.',
  ...
  pt: {
    ...
    refineHint: 'Pressione Enter para enviar. Gemini 3.7 Flash atualizará seu diagrama.',
  ...
  ja: {
    ...
    refineHint: 'Enterキーで送信。Gemini 3.7 Flashが図面を更新します。',
  ...
  de: {
    ...
    refineHint: 'Eingabetaste drücken. Gemini 3.7 Flash verfeinert Ihr Diagramm.',
  ...
  id: {
    ...
    refineHint: 'Tekan Enter untuk mengirim. Gemini 3.7 Flash akan memperbarui diagram Anda.',
  ...
  ar: {
    ...
    refineHint: 'اضغط Enter للإرسال. سيقوم Gemini 3.7 Flash بتحديث المخطط.',
  ...
  zh: {
    ...
    refineHint: '按 Enter 發送。Gemini 3.7 Flash 將智能更新您的架構圖。',
