...
export const ARCHETYPE_REGISTRY: Record<ArchetypeId, DocArchetype> = {
  fdd: {
    ...
    description: 'Detailed functional specifications, system flows, interface contracts, and actors.',
    diagramTypes: ['conceptual_diagram', 'unified_system_view', 'sequence_diagram', 'erd'],
    sections: [
      { id: 'overview', title: 'Functional System Overview', provenance: 'derived', mapper: 'componentDescriptions' },
      { id: 'components', title: 'Component Descriptions & Responsibilities', provenance: 'derived', mapper: 'componentDescriptions' },
      { id: 'interfaces', title: 'Interface Definitions & Protocol Contracts', provenance: 'derived', mapper: 'interfaceInventory' },
      { id: 'functional_flows', title: 'Functional Sequence Flows & User Stories', provenance: 'derived', mapper: 'userStories' },
      { id: 'data_model', title: 'Data Model & Entity Relationships', provenance: 'derived', mapper: 'componentDescriptions' },
      { id: 'error_handling', title: 'Error Handling, Resilience & Edge Cases', provenance: 'inferred', inferPrompt: 'error_handling' },
    ],
  },
  prd: {
    id: 'prd',
