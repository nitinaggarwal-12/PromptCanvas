...
export function renderMarkdown(input: ComposeRenderInput): string {
  ...
  const SECTION_DIAGRAM_INSERTION_MAP: Record<string, Record<string, string[]>> = {
    ...
    fdd: {
      ...
      safety_pv_detection: ['governance_state_machine', 'eval_safety_benchmarking'],
      compliance_qc: ['erd'],
    },
    brd: {
    ...
    tdd: {
      ...
      cicd_automation: ['tech_cicd_pipeline', 'eval_safety_benchmarking'],
    },
    exec_brief: {
      ...
      autonomy_ladder_oversight: ['governance_state_machine', 'eval_safety_benchmarking'],
