...
export function buildMasterBlueprint61EnterpriseAiDocumentAssistantXml(): string {
  const cells: string[] = [
    ...
    edge('e_hitl_notif', 'n_hitl', 'n_notif', 'Send Review Alert', '#EF4444', 0),
    edge('e_notif_teams', 'n_notif', 'ch_teams', 'Teams/Slack Push', '#EF4444', 0, 0.5, 0, 0.5, 1, [[1207, 280], [910, 280]]),
    edge('e_docai_bq', 'n_docai', 'n_bq', 'Extract Line Items', '#1D4ED8', 1, 0.5, 1, 0.5, 0, [[235, 525], [412, 525]]),
    edge('e_fire_bff', 'n_fire', 'n_bff', 'Restore State', '#F59E0B', 1, 0.5, 0, 0.5, 0, [[960, 640], [130, 640], [130, 340]]),
    edge('e_pub_eventarc', 'n_pubsub', 'n_eventarc', 'Event Fan-out', '#EC4899', 0),
    edge('e_eventarc_workers', 'n_eventarc', 'n_workers', 'Trigger Workers', '#EC4899', 0),
    edge('e_workers_webhooks', 'n_workers', 'n_webhooks', 'Outbound Push', '#EC4899', 0),
    edge('e_workers_integrations', 'n_webhooks', 'n_integrations', 'ERP Push', '#EC4899', 0),
    edge('e_cicd_iac', 'n_cicd', 'n_iac', 'Apply IaC Plan', '#8B5CF6', 0),
    edge('e_dlp_audit', 'n_dlp', 'n_audit', 'Audit PII Redactions', '#10B981', 0),
