...
const zone=(id:string,n:number,title:string,sub:string,x:number,a:number,b:string|number,c:string|number,d?:string,e?:string)=>{
 ...
 const y=customGeometry?a:25,w=customGeometry?b as number:a,h=customGeometry?c as number:620,accent=customGeometry?d!:b as string,fill=customGeometry?e!:c as string;
 return [
