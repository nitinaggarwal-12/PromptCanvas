...
const streamingGraph: Studio1SemanticGraph = {
  ...
  edges: [
    ...
    { id: 'subscription_processor', source: 'streaming_subscription', target: 'processor', label: 'Pull retained events', flowType: 'asynchronous', relationType: 'subscribes', step: 6 },
    ...
    { id: 'valid_warehouse', source: 'validator', target: 'warehouse', label: 'Write valid analytics', flowType: 'data', relationType: 'writes', condition: 'schema_valid', step: 8 },
    { id: 'invalid_quarantine', source: 'validator', target: 'raw_archive', label: 'Quarantine invalid record', flowType: 'data', relationType: 'writes', condition: 'schema_invalid', step: 9 },
    ...
    { id: 'iam_api', source: 'iam', target: 'ingestion_api', label: 'Authorize service account', flowType: 'governance', relationType: 'authorizes', step: 13 },
    { id: 'logging_api', source: 'logging', target: 'ingestion_api', label: 'Collect request logs', flowType: 'governance', relationType: 'observes', step: 14 },
