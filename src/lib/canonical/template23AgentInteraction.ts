...
export function generateTemplate23AgentInteractionXml(
  ...
  cell("hdr_num", "23", 16, 12, 68, 54, "shape=rectangle;rounded=1;arcSize=14;fillColor=#6D28D9;strokeColor=#6D28D9;fontColor=#FFFFFF;fontSize=28;fontStyle=1;align=center;verticalAlign=middle;");
  ...
  const agents = [
    ...
    { name: "Compliance<br/>Agent", desc: "Checks rules, policies &amp; regs", pill: "Specialized", pbg: "#EFF6FF", pfg: "#0284C7", icon: "●", bg: "#EFF6FF", bc: "#BAE6FD" },
  ...
  const dataStores = [
    { t: "Vector DB<br/><span style='color:#64748B;'>(Embeddings)</span>", icon: "●" },
    { t: "Document Store<br/><span style='color:#64748B;'>(Knowledge Base)</span>", icon: "●" },
    { t: "Graph DB<br/><span style='color:#64748B;'>(Relationships)</span>", icon: "●" },
  ...
  cell("lbl_r_risks", " KEY RISKS", 1230, 324, 290, 16, "text;html=1;strokeColor=none;fillColor=none;fontColor=#DC2626;fontSize=8;fontStyle=1;align=center;verticalAlign=middle;");
  ...
  const bMemHtml = `<div style="font-size:7px;line-height:1.55;color:#0F172A;padding:4px 6px;">
     ...
     <b>Long-term Memory</b> (Vector / Graph DB)<br/><br/>
     <b>Conversation Summarization</b><br/><br/>
     <b>Context Window Management</b><br/><br/>
  ...
  const bObsHtml = `<div style="font-size:7px;line-height:1.55;color:#0F172A;padding:4px 6px;">
    ...
    ⏱ <b>Latency &amp; Throughput Metrics</b><br/><br/>
     <b>Agent Health &amp; Availability</b><br/><br/>
