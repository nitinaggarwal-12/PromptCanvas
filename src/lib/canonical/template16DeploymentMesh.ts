...
export function generateTemplate16DeploymentMeshXml(
  ...
  cell("hdr_num", "16", 16, 12, 68, 54, "shape=rectangle;rounded=1;arcSize=14;fillColor=#1E3A8A;strokeColor=#1E3A8A;fontColor=#FFFFFF;fontSize=28;fontStyle=1;align=center;verticalAlign=middle;");
  ...
  const legPillsHtml = `<div style="font-size:10px;display:flex;justify-content:space-around;align-items:center;padding:4px;">
    ...
    <span><span style="color:#D97706;font-size:14px;"></span> <b>Security</b></span>
  </div>`;
  ...
  cell("node_ilb", "<div style='font-size:8.5px;font-weight:800;color:#1E40AF;'> &nbsp; Internal HTTP(S) Load Balancer</div>", 310, 184, 712, 28, "rounded=1;arcSize=6;fillColor=#EFF6FF;strokeColor=#BFDBFE;html=1;align=center;verticalAlign=middle;");
  ...
  zones.forEach((zn, idx) => {
    ...
    cell(`lbl_app_${zn.id}`, " Application Tier<br/>(GKE Autopilot)", zn.x, 240, 232, 24, "text;html=1;strokeColor=none;fillColor=none;fontColor=#16A34A;fontSize=8;fontStyle=1;align=center;verticalAlign=middle;");
  ...
  cell("lbl_data_tier", " Data Tier (Regional)", 310, 476, 712, 16, "text;html=1;strokeColor=none;fillColor=none;fontColor=#7C3AED;fontSize=9;fontStyle=1;align=center;verticalAlign=middle;");

  const dbCards = [
    { id: "db_alloy", t: "AlloyDB<br/>(PostgreSQL)", icon: "●", w: 110 },
  ...
  const sharedItems = [
    { t: "Cloud Storage<br/>(Artifacts / Files)", icon: "●" },
    ...
    { t: "Workflows<br/>(Orchestration)", icon: "●" }
  ];
  ...
  cell("lbl_dr_reg", " DR REGION (us-east1)", 1046, 128, 190, 18, "text;html=1;strokeColor=none;fillColor=none;fontColor=#2563EB;fontSize=9.5;fontStyle=1;align=center;verticalAlign=middle;");

  cell("dr_gke", "<div style='font-size:22px;text-align:center;'></div><div style='font-size:8.5px;font-weight:800;color:#0F172A;text-align:center;margin-top:4px;'>GKE Autopilot</div><div style='font-size:7.5px;color:#64748B;text-align:center;'>(Standby)</div>", 1056, 160, 170, 96, "rounded=1;arcSize=6;fillColor=#F0FDF4;strokeColor=#16A34A;html=1;align=center;verticalAlign=middle;padding=4;");
  ...
  cell("dr_shared", "<div style='font-size:22px;text-align:center;'></div><div style='font-size:8.5px;font-weight:800;color:#0F172A;text-align:center;margin-top:4px;'>Shared Services</div><div style='font-size:7.5px;color:#64748B;text-align:center;'>(Standby)</div>", 1056, 554, 170, 92, "rounded=1;arcSize=6;fillColor=#F8FAFC;strokeColor=#CBD5E1;html=1;align=center;verticalAlign=middle;padding=4;");
  ...
  const scalingHtml = `<div style="font-size:8.5px;line-height:1.55;color:#0F172A;padding:6px 8px;">
     <b>Horizontal Pod Autoscaler (GKE)</b><br/>
  ...
  const tools = [
    { t: "Terraform<br/>(IaC)", icon: "●" },
    { t: "Cloud Build<br/>(CI/CD)", icon: "●" },
  ...
  const pipelineSteps = [
    ...
    { id: "ps_2", t: "Build<br/>(Cloud Build)", icon: "●" },
    { id: "ps_3", t: "Scan<br/>(Artifact Analysis)", icon: "●" },
