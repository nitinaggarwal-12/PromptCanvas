...
export function generateTemplate18SecurityTrustBoundaryXml(
  ...
  cell("hdr_num", "18", 16, 12, 68, 54, "shape=rectangle;rounded=1;arcSize=14;fillColor=#6D28D9;strokeColor=#6D28D9;fontColor=#FFFFFF;fontSize=28;fontStyle=1;align=center;verticalAlign=middle;");
  ...
  cell("lbl_net_boundary", " NETWORK<br/>BOUNDARY", 286, 64, 64, 24, "text;html=1;strokeColor=none;fillColor=none;fontColor=#2563EB;fontSize=8;fontStyle=1;align=center;");
  ...
  cell("lbl_gcp_trusted", " GOOGLE CLOUD – TRUSTED ZONE (us-central1)", 326, 90, 674, 20, "text;html=1;strokeColor=none;fillColor=none;fontColor=#2563EB;fontSize=11;fontStyle=1;align=center;verticalAlign=middle;");
  ...
  cell("app_gw", "<div style='font-size:24px;text-align:center;'></div><div style='font-size:9px;font-weight:800;color:#0F172A;text-align:center;margin-top:2px;'>API Gateway<br/><span style='color:#64748B;'>(Cloud Endpoints)</span></div>", 502, 262, 136, 116, "rounded=1;arcSize=4;fillColor=#FFFFFF;strokeColor=#CBD5E1;html=1;align=center;verticalAlign=middle;padding=4;");
  cell("app_back", "<div style='font-size:24px;text-align:center;'></div><div style='font-size:9px;font-weight:800;color:#0F172A;text-align:center;margin-top:2px;'>Backend Services<br/><span style='color:#64748B;'>(GKE / Cloud Run)</span></div>", 502, 390, 136, 138, "rounded=1;arcSize=4;fillColor=#FFFFFF;strokeColor=#CBD5E1;html=1;align=center;verticalAlign=middle;padding=4;");
  ...
  cell("dat_db", "<div style='font-size:24px;text-align:center;'></div><div style='font-size:9px;font-weight:800;color:#0F172A;text-align:center;margin-top:2px;'>Primary Database<br/><span style='color:#64748B;'>(Cloud SQL)</span></div>", 666, 150, 136, 100, "rounded=1;arcSize=4;fillColor=#FFFFFF;strokeColor=#CBD5E1;html=1;align=center;verticalAlign=middle;padding=4;");
  cell("dat_gcs", "<div style='font-size:24px;text-align:center;'></div><div style='font-size:9px;font-weight:800;color:#0F172A;text-align:center;margin-top:2px;'>Object Storage<br/><span style='color:#64748B;'>(Cloud Storage)</span></div>", 666, 262, 136, 116, "rounded=1;arcSize=4;fillColor=#FFFFFF;strokeColor=#CBD5E1;html=1;align=center;verticalAlign=middle;padding=4;");
  ...
  const mgmtItems = [
    { t: "IAM &amp; Admin<br/><span style='font-size:7.5px;color:#64748B;'>(Least Privilege)</span>", icon: "●" },
  ...
  cell("lbl_data_class", " DATA<br/>CLASSIFICATION", 1016, 88, 124, 30, "text;html=1;strokeColor=none;fillColor=none;fontColor=#DC2626;fontSize=9.5;fontStyle=1;html=1;align=center;verticalAlign=middle;");
  ...
  const legendHtml = `<table style="width:100%;border-collapse:collapse;font-size:9px;margin-top:4px;line-height:1.5;padding:4px 8px;">
    ...
    <tr style="height:24px;"><td style="color:#2563EB;font-weight:900;"></td><td><b>Security Control</b></td></tr>
