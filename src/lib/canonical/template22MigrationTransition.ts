...
export function generateTemplate22MigrationTransitionXml(
  ...
  cell("hdr_num", "22", 16, 12, 68, 54, "shape=rectangle;rounded=1;arcSize=14;fillColor=#6D28D9;strokeColor=#6D28D9;fontColor=#FFFFFF;fontSize=28;fontStyle=1;align=center;verticalAlign=middle;");
  ...
  const curItems = [
    ...
    { t: "Data Stores", sub: "Oracle DB<br/>File Shares (NAS)<br/>Document Repos", icon: "●" },
  ...
  const phases = [
    {
      ...
      cards: [
        ...
        { t: "Risk &amp; Dependency Analysis", sub: "Technical, data, operational risks", icon: "●" },
    ...
    },
    {
      ...
      cards: [
        { t: "Target Landing Zone", sub: "Network, IAM, security, observability", icon: "●" },
        { t: "Platform &amp; Services Provisioning", sub: "Core platform and shared services", icon: "●" },
        { t: "Data Migration Setup", sub: "Connectivity, tools, validation rules", icon: "●" },
    ...
    },
    {
      ...
      cards: [
        { t: "Performance Tuning", sub: "Right size, caching, indexes", icon: "⏱" },
        { t: "Resilience Hardening", sub: "HA/DR, backup, failover testing", icon: "●" },
  ...
  const targetItems = [
    { t: "Applications", sub: "Microservices<br/>Managed Services<br/>Serverless", icon: "●" },
    { t: "Data Layer", sub: "Cloud SQL<br/>BigQuery<br/>Object Storage", icon: "●" },
    { t: "Integrations", sub: "API Gateway<br/>Event-Driven<br/>Standard APIs", icon: "●" },
    { t: "Platform", sub: "GKE / Cloud Run<br/>Cloud Services<br/>Global Network", icon: "●" },
  ...
  const pattHtml = `<div style="font-size:8px;line-height:1.35;color:#0F172A;padding:2px 6px;">
     ...
     <b>Refactor / Replatform</b><br/>
     <b>Rearchitect</b> (Cloud Native)<br/>
     <b>Retire / Decommission</b><br/>
  ...
  cell("lbl_m_risks", " KEY RISKS", 1234, 334, 286, 16, "text;html=1;strokeColor=none;fillColor=none;fontColor=#DC2626;fontSize=8;fontStyle=1;align=center;verticalAlign=middle;");
  ...
  const bStakeHtml = `<div style="font-size:7px;line-height:1.45;color:#0F172A;padding:4px 6px;">
     ...
     <b>Application Owners</b><br/><br/>
     <b>Data Owners</b><br/><br/>
     <b>Platform / Infrastructure</b><br/><br/>
     <b>Security &amp; Compliance</b><br/><br/>
  ...
  const bToolsHtml = `<div style="font-size:7px;line-height:1.4;color:#0F172A;padding:4px 6px;">
     <b>Google Cloud (GCP)</b><br/><span style="color:#64748B;">Landing Zone, GKE, Cloud SQL, BigQuery</span><br/><br/>
     <b>Database Migration Service (DMS)</b><br/><br/>
     <b>Data Transfer Appliance</b><br/><br/>
     <b>Infrastructure as Code (Terraform)</b><br/><br/>
