...
export function generateTemplate24RagKnowledgeFlowXml(
  ...
  cell("hdr_num", "24", 16, 12, 68, 54, "shape=rectangle;rounded=1;arcSize=14;fillColor=#6D28D9;strokeColor=#6D28D9;fontColor=#FFFFFF;fontSize=28;fontStyle=1;align=center;verticalAlign=middle;");
  ...
  const intSources = [
    ...
    { t: "Email / Tickets / Notes", icon: "●" },
    { t: "Databases<br/><span style='color:#64748B;'>(SQL, Oracle, BQ)</span>", icon: "●" }
  ];
  ...
  const extSources = [
    { t: "Public Regulations<br/><span style='color:#64748B;'>(FDA, EMA, PMDA)</span>", icon: "●" },
    { t: "Standards &amp; Guidelines<br/><span style='color:#64748B;'>(ICH, ISO, GxP)</span>", icon: "●" },
  ...
  const ragStages = [
    ...
    },
    {
      ...
      cards: [
        ...
        { t: "Text Chunking<br/><span style='color:#64748B;'>(Semantic / Token)</span>", icon: "●" },
        { t: "Metadata Extraction<br/><span style='color:#64748B;'>(Entities, Tags)</span>", icon: "●" },
    ...
    },
    {
      ...
      cards: [
        ...
        { t: "Vectorization", icon: "●" },
        { t: "Indexing &amp; Upsert<br/><span style='color:#64748B;'>(Vector DB)</span>", icon: "●" },
    ...
    },
    {
      ...
      cards: [
        ...
        { t: "Prompt Construction<br/><span style='color:#64748B;'>(System + Context)</span>", icon: "●" }
      ]
    },
    {
      num: "7", name: "GENERATE",
      cards: [
        ...
        { t: "Tool / Function Calls<br/><span style='color:#64748B;'>(If needed)</span>", icon: "●" },
        { t: "Guardrails &amp; Safety<br/>Checks", icon: "●" },
    ...
    },
    {
      ...
      cards: [
        ...
        { t: "Answer Evaluation<br/><span style='color:#64748B;'>(LLM-as-a-Judge)</span>", icon: "●" },
  ...
  const kStores = [
    { t: "Raw Document Store<br/><span style='color:#64748B;'>(Cloud Storage)</span>", icon: "●" },
    ...
    { t: "Graph Database<br/><span style='color:#64748B;'>(Neo4j / AlloyDB)</span>", icon: "●" },
  ...
  const crossCaps = ["Security &amp; IAM (Least Privilege)", "Data Governance", " PII &amp; Confidentiality", "Audit Logging", " Quality Monitoring", "Cost &amp; Perf", "Multi-tenancy"];
  ...
  const rStratHtml = `<div style="font-size:8px;line-height:1.35;color:#0F172A;padding:2px 6px;">
     ...
     <b>Metadata Filters</b> (Date, Source, Type)
  </div>`;
  ...
  const rGuardsHtml = `<div style="font-size:8px;line-height:1.35;color:#0F172A;padding:2px 6px;">
     <b>Prompt Injection Detection</b><br/>
     <b>Toxicity &amp; Safety Filters</b><br/>
  ...
  cell("lbl_r_risks", " KEY RISKS", 1230, 500, 290, 16, "text;html=1;strokeColor=none;fillColor=none;fontColor=#DC2626;fontSize=8;fontStyle=1;align=center;verticalAlign=middle;");
  ...
  const ragTechs = [
    ...
    { t: "Vertex Matching<br/>Engine", icon: "●" },
    { t: "AlloyDB / PG", icon: "●" },
    { t: "BigQuery", icon: "●" },
  ...
  const highFlow = [
    { t: "Sources", icon: "●", sub: "Enterprise Data" },
    { t: "Ingest", icon: "●", sub: "CDC &amp; ETL" },
  ...
  const bGovHtml = `<div style="font-size:8px;line-height:1.45;color:#0F172A;padding:4px 6px;">
     ...
     <b>Access Control &amp; Audit</b><br/>
     <b>Regulatory Compliance (GxP, GDPR)</b><br/>
