 ...
 * Functional Enterprise Agent Engineering Specification:
 * Multi-Modal Reasoning, Native Long-Context (2M+ Tokens), Factual Grounding Citations & Parallel Execution Kernel
 */
  ...
  <diagram id="hitl-agent-gov" name="Human-in-the-Loop Autonomous AI Agent Governance Lifecycle">
    <mxGraphModel dx="1600" dy="900" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="1920" pageHeight="1060" background="#FFFFFF">
      <root>
        ...
        <mxCell id="header_sub" value="Functional Agentic AI Architecture: [1. 2M+ Token Long-Context Policy Engine] • [2. Factual Grounding Citation Engine] • [3. Constitutional HHH Safety Gate] • [4. Run State Machine (requires_action)] • [5. Continuous RLHF Loop]" style="text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;whiteSpace=wrap;rounded=0;fontSize=12;fontStyle=1;fontColor=#0284C7;" vertex="1" parent="1">
        ...
        <mxCell id="col1_title" value="TIER 1: LONG-CONTEXT INGRESS &amp;amp; FACTUAL GROUNDING" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#1E3A8A;strokeColor=#0F172A;fontColor=#FFFFFF;fontStyle=1;fontSize=12;" vertex="1" parent="1">
          <mxGeometry x="80" y="125" width="340" height="40" as="geometry" />
        </mxCell>

        <mxCell id="c1_box1" value="&lt;b style='font-size:12px;color:#0F172A;'&gt;Native 2M+ Token Long-Context Ingress Window&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:10px;color:#1E293B;'&gt;• Interleaved Audio WebRTC, Video Streams &amp;amp; Full Document Ingress&lt;br/&gt;• Ephemeral System Prompt &amp;amp; Policy Document Caching (90% Cost Cut)&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#FFFFFF;strokeColor=#0284C7;strokeWidth=2;fontColor=#0F172A;align=left;spacingLeft=14;spacingTop=6;" vertex="1" parent="1">
        ...
        <mxCell id="c1_gate" value="🛡️ Deterministic Factual Grounding &amp;amp; Constitutional HHH Pass" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#1E40AF;strokeColor=#1E3A8A;strokeWidth=2;fontColor=#FFFFFF;fontStyle=1;fontSize=12;" vertex="1" parent="1">
        ...
        <mxCell id="c2_track_title" value="Three-Tier Grounding &amp;amp; Confidence Routing Matrix" style="text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;whiteSpace=wrap;rounded=0;fontColor=#0F172A;fontStyle=1;fontSize=11;" vertex="1" parent="1">
          <mxGeometry x="505" y="188" width="370" height="20" as="geometry" />
        </mxCell>

        <mxCell id="conf_tier1" value="&lt;b style='color:#14532D;'&gt;🟢 Fast Path&lt;br/&gt;(&amp;ge; 95% Conf)&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:9px;color:#1E293B;'&gt;Grounded Action&lt;br/&gt;Auto-Executed&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#DCFCE7;strokeColor=#16A34A;strokeWidth=2;fontColor=#0F172A;fontSize=10;spacingTop=6;" vertex="1" parent="1">
          <mxGeometry x="515" y="212" width="105" height="185" as="geometry" />
        </mxCell>
        <mxCell id="conf_tier2" value="&lt;b style='color:#713F12;'&gt;🟡 AI Audit&lt;br/&gt;(75% - 94%)&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:9px;color:#1E293B;'&gt;Supervisor AI&lt;br/&gt;Citation Verification&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#FEF9C3;strokeColor=#D97706;strokeWidth=2;fontColor=#0F172A;fontSize=10;spacingTop=6;" vertex="1" parent="1">
        ...
        <mxCell id="supervisor_box" value="&lt;b style='font-size:11px;color:#0F172A;'&gt;SUPERVISOR AI FACTUAL GROUNDING &amp;amp; REASONING HUB&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:10px;color:#1E293B;'&gt;• Verifies Tool Claims against Verifiable Citations &amp;amp; Parallel Code Interpreter&lt;br/&gt;• Promotes Verified Grounded Actions (≥95%) to Fast-Path Execution&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#FFFFFF;strokeColor=#0284C7;strokeWidth=2;fontColor=#0F172A;align=left;spacingLeft=14;spacingTop=6;" vertex="1" parent="1">
        ...
        <mxCell id="hitl_console" value="&lt;b style='font-size:12px;color:#0F172A;'&gt;Human Compliance Review Workbench (submit_tool_outputs)&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:10px;color:#1E293B;'&gt;• Displays Grounded Source Citations, Tool Payload &amp;amp; Risk Rationale&lt;br/&gt;• Shows Confidence Gap Breakdown &amp;amp; Factual Support Audit&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#FFFFFF;strokeColor=#0284C7;strokeWidth=2;fontColor=#0F172A;align=left;spacingLeft=14;spacingTop=6;" vertex="1" parent="1">
        ...
        <mxCell id="col4_title" value="TIER 4: PARALLEL EXECUTION KERNEL &amp;amp; AUDIT" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#1E3A8A;strokeColor=#0F172A;fontColor=#FFFFFF;fontStyle=1;fontSize=12;" vertex="1" parent="1">
          <mxGeometry x="1420" y="125" width="400" height="40" as="geometry" />
        </mxCell>

        <mxCell id="c4_exec" value="&lt;b style='font-size:12px;color:#0F172A;'&gt;Parallel Code Interpreter Kernel &amp;amp; GUI Automation&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:10px;color:#14532D;'&gt;• Sandboxed Code Execution Kernel &amp;amp; Virtual OS GUI Automation&lt;br/&gt;• Idempotent API Execution with Transactional Rollback Protection&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#DCFCE7;strokeColor=#16A34A;strokeWidth=2;fontColor=#0F172A;align=left;spacingLeft=14;spacingTop=6;" vertex="1" parent="1">
          <mxGeometry x="1425" y="180" width="390" height="115" as="geometry" />
        </mxCell>

        <mxCell id="c4_audit" value="&lt;b style='font-size:12px;color:#0F172A;'&gt;Immutable Regulatory Audit Evidence Store&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:10px;color:#1E293B;'&gt;• Persists Agent Prompt, Grounding Citations, HITL Token &amp;amp; Diff&lt;br/&gt;• SOC2 / HIPAA / EU AI Act Compliance Record Ready&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#FFFFFF;strokeColor=#0284C7;strokeWidth=2;fontColor=#0F172A;align=left;spacingLeft=14;spacingTop=6;" vertex="1" parent="1">
        ...
        <mxCell id="legend_box" value="&lt;b style='font-size:11px;'&gt;FUNCTIONAL ENTERPRISE AGENTIC AI ARCHITECTURE SPECIFICATION:&lt;/b&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp;[Native 2M+ Token Long-Context Window] • [Deterministic Factual Grounding Engine] • [Parallel Code Execution Kernel] • [Constitutional HHH Gate] • [Run Lifecycle requires_action HITL Gate]&lt;br/&gt;&lt;span style='font-size:10px;color:#1E293B;'&gt;• &lt;b&gt;Routing Rules:&lt;/b&gt; Confidence &amp;ge; 95% &amp;rarr; Fast-Path Auto-Approve  |  75%–94% &amp;rarr; Supervisor AI Citation Audit  |  &amp;lt; 75% &amp;rarr; Mandatory Human Review Escalation (submit_tool_outputs)&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#F1F5F9;strokeColor=#64748B;strokeWidth=1.5;fontColor=#0F172A;fontSize=10;align=center;" vertex="1" parent="1">
        ...
        <mxCell id="e_c1_gate" value="Factual Grounding Pass" style="edgeStyle=orthogonalEdgeStyle;rounded=1;orthogonalLoop=1;jettySize=auto;html=1;strokeColor=#0284C7;strokeWidth=3;fontColor=#0284C7;fontStyle=1;fontSize=10;labelBackgroundColor=#FFFFFF;" edge="1" parent="1" source="c1_track_bg" target="c1_gate">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
...
export function getExactMultiAgentLangGraphReferenceXml(): string {
  return `
<mxfile host="app.diagrams.net" modified="${new Date().toISOString()}" agent="PromptCanvas" version="21.0.0" type="device">
  <diagram id="multi-agent-langgraph" name="Multi-Agent Autonomous LLM Orchestration Platform (Stateful Directed Acyclic Graph)">
    <mxGraphModel dx="1600" dy="900" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="1920" pageHeight="1060" background="#FFFFFF">
      <root>
        <mxCell id="0" />
        <mxCell id="1" parent="0" />
        ...
        <!-- Figure Title Banner -->
        <mxCell id="header_title" value="FIGURE 2: MULTI-AGENT AUTONOMOUS ORCHESTRATION PLATFORM (LONG-CONTEXT &amp;amp; FACTUAL GROUNDING)" style="text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;whiteSpace=wrap;rounded=0;fontSize=18;fontStyle=1;fontColor=#0F172A;" vertex="1" parent="1">
          <mxGeometry x="50" y="50" width="1820" height="28" as="geometry" />
        </mxCell>
        <mxCell id="header_sub" value="Functional Architecture Spec: [1. Native 2M+ Token Context Window] • [2. Factual Grounding Citation Engine] • [3. Parallel Code Execution Kernel] • [4. Multi-Step Reasoning Budget]" style="text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;whiteSpace=wrap;rounded=0;fontSize=12;fontStyle=1;fontColor=#0284C7;" vertex="1" parent="1">
          <mxGeometry x="50" y="78" width="1820" height="22" as="geometry" />
        </mxCell>
        ...
        <mxCell id="col1_title" value="TIER 1: MASTER SUPERVISOR &amp;amp; LONG-CONTEXT ENGINE" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#1E3A8A;strokeColor=#0F172A;fontColor=#FFFFFF;fontStyle=1;fontSize=12;" vertex="1" parent="1">
          <mxGeometry x="80" y="125" width="340" height="40" as="geometry" />
        </mxCell>

        <mxCell id="c1_client" value="&lt;b style='font-size:12px;color:#0F172A;'&gt;Multimodal WebRTC / 2M+ Token Long Context Ingress&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:10px;color:#1E293B;'&gt;• Interleaved Audio/Video Streams, Whole-Repository &amp;amp; Enterprise Datastores&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#FFFFFF;strokeColor=#0284C7;strokeWidth=2;fontColor=#0F172A;align=left;spacingLeft=14;spacingTop=6;" vertex="1" parent="1">
          <mxGeometry x="85" y="180" width="330" height="115" as="geometry" />
        </mxCell>
        <mxCell id="c1_supervisor" value="&lt;b style='font-size:12px;color:#0F172A;'&gt;[Agent 1: Orchestrator] Master Directed Graph Supervisor&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:10px;color:#0284C7;'&gt;• Decomposes Goal into Directed Acyclic Task Graph (DAG)&lt;br/&gt;• Multi-Step Reasoning Allocation &amp;amp; Hierarchical Peer Handoff Routines&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#FFFFFF;strokeColor=#0284C7;strokeWidth=2;fontColor=#0F172A;align=left;spacingLeft=14;spacingTop=6;" vertex="1" parent="1">
          <mxGeometry x="85" y="330" width="330" height="135" as="geometry" />
        </mxCell>
        <mxCell id="c1_state" value="&lt;b style='font-size:12px;color:#0F172A;'&gt;Run Lifecycle State Machine &amp;amp; Grounding Checkpoint Store&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:10px;color:#1E293B;'&gt;• Manages Run Object Lifecycle (queued -&amp;gt; in_progress -&amp;gt; requires_action)&lt;br/&gt;• Verifiable Citation Index &amp;amp; Fault-Tolerant Step Memory Checkpointer&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#FFFFFF;strokeColor=#0284C7;strokeWidth=2;fontColor=#0F172A;align=left;spacingLeft=14;spacingTop=6;" vertex="1" parent="1">
        ...
        <mxCell id="w_rag" value="&lt;b style='font-size:12px;color:#0F172A;'&gt;[Agent 2: Grounding Specialist] Research &amp;amp; Retrieval Agent&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:10px;color:#1E293B;'&gt;• Native 2M Token Repository Scan &amp;amp; Vector Citation Extraction&lt;br/&gt;• Assigns deterministic factual confidence support score to claims&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#FFFFFF;strokeColor=#0284C7;strokeWidth=2;fontColor=#0F172A;align=left;spacingLeft=14;spacingTop=6;" vertex="1" parent="1">
          <mxGeometry x="500" y="180" width="380" height="115" as="geometry" />
        </mxCell>

        <!-- Worker Stack 2: Code & SQL Generator -->
        <mxCell id="w_code" value="&lt;b style='font-size:12px;color:#0F172A;'&gt;[Agent 3: Synthesis Specialist] Code &amp;amp; Parallel Execution Agent&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:10px;color:#0284C7;'&gt;• Synthesizes executable Python code, Analytical SQL &amp;amp; Infrastructure IaC&lt;br/&gt;• Generates Virtual OS Computer Use GUI Action Sequences (mouse/type)&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#FFFFFF;strokeColor=#0284C7;strokeWidth=2;fontColor=#0F172A;align=left;spacingLeft=14;spacingTop=6;" vertex="1" parent="1">
          <mxGeometry x="500" y="320" width="380" height="115" as="geometry" />
        </mxCell>

        <!-- Worker Stack 3: Verification Critic -->
        <mxCell id="w_verify" value="&lt;b style='font-size:12px;color:#0F172A;'&gt;[Agent 4: Reflection Agent] Verification &amp;amp; Safety Critic&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:10px;color:#14532D;'&gt;• Performs Factual Grounding Verification &amp;amp; Parallel Code Validation&lt;br/&gt;• Evaluates generated code prior to isolated sandbox dispatch&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#DCFCE7;strokeColor=#16A34A;strokeWidth=2;fontColor=#0F172A;align=left;spacingLeft=14;spacingTop=6;" vertex="1" parent="1">
          <mxGeometry x="500" y="460" width="380" height="115" as="geometry" />
        </mxCell>

        <!-- Consensus Hub -->
        <mxCell id="consensus_hub" value="&lt;b style='font-size:12px;'&gt;AGENT HAND-OFF SYNCHRONIZATION &amp;amp; CONSENSUS HUB&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:10px;'&gt;Executes Dynamic Peer Transfers &amp;amp; Validates Grounding Citation Metadata &amp;amp; Strict Pydantic Payload&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#1E3A8A;strokeColor=#0F172A;strokeWidth=2;fontColor=#FFFFFF;fontStyle=1;spacingTop=6;" vertex="1" parent="1">
        ...
        <mxCell id="col3_title" value="TIER 3: PARALLEL EXECUTION KERNEL &amp;amp; CITATIONS [PATTERN 2]" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#1E3A8A;strokeColor=#0F172A;fontColor=#FFFFFF;fontStyle=1;fontSize=12;" vertex="1" parent="1">
          <mxGeometry x="960" y="125" width="380" height="40" as="geometry" />
        </mxCell>

        <mxCell id="c3_sandbox" value="&lt;b style='font-size:12px;color:#0F172A;'&gt;Sandboxed Parallel Code Execution Kernel&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:10px;color:#14532D;'&gt;• Executes Python verification scripts in parallel inside microVM sandbox&lt;br/&gt;• Autonomous GUI desktop navigation (mouse_click, type_text, screenshot)&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#DCFCE7;strokeColor=#16A34A;strokeWidth=2;fontColor=#0F172A;align=left;spacingLeft=14;spacingTop=6;" vertex="1" parent="1">
          <mxGeometry x="965" y="180" width="370" height="135" as="geometry" />
        </mxCell>

        <mxCell id="store_pgvector" value="&lt;b style='font-size:12px;color:#0F172A;'&gt;🗄️ Managed Factual Grounding &amp;amp; Vector Knowledge Store&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:10px;color:#0284C7;'&gt;• Direct Whole-Document 2M+ Token Context Memory Index&lt;br/&gt;• Ephemeral System Prompt &amp;amp; Document Caching (90% Cost &amp;amp; 85% Latency Cut)&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#FFFFFF;strokeColor=#0284C7;strokeWidth=2;fontColor=#0F172A;align=left;spacingLeft=14;spacingTop=6;" vertex="1" parent="1">
          <mxGeometry x="965" y="335" width="370" height="130" as="geometry" />
        </mxCell>

        <mxCell id="store_grpc" value="&lt;b style='font-size:12px;color:#0F172A;'&gt;🔌 gRPC / REST Enterprise Tool Call Gateway&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:10px;color:#6B21A8;'&gt;• Connects Agents to Analytical Warehouses, Microservices &amp;amp; DevOps APIs&lt;br/&gt;• Mutual TLS (mTLS) Auth &amp;amp; Strict Structured Output Validation Gate&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#F3E8FF;strokeColor=#9333EA;strokeWidth=2;fontColor=#0F172A;align=left;spacingLeft=14;spacingTop=6;" vertex="1" parent="1">
        ...
        <mxCell id="col4_title" value="TIER 4: REQUIRES_ACTION HITL GATE &amp;amp; CITATIONS" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#1E3A8A;strokeColor=#0F172A;fontColor=#FFFFFF;fontStyle=1;fontSize=12;" vertex="1" parent="1">
          <mxGeometry x="1420" y="125" width="400" height="40" as="geometry" />
        </mxCell>

        <mxCell id="c4_interrupt" value="&lt;b style='font-size:12px;color:#0F172A;'&gt;[Agent 5: Governance Arbitrator] requires_action HITL Gate&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:10px;color:#713F12;'&gt;• Intercepts Run Lifecycle prior to Production Mutating API Calls&lt;br/&gt;• Displays Verifiable Source Citations &amp;amp; Parallel Execution Output to Human Reviewer&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#FEF9C3;strokeColor=#D97706;strokeWidth=2;fontColor=#0F172A;align=left;spacingLeft=14;spacingTop=6;" vertex="1" parent="1">
          <mxGeometry x="1425" y="180" width="390" height="135" as="geometry" />
        </mxCell>

        <mxCell id="c4_synthesis" value="&lt;b style='font-size:12px;color:#0F172A;'&gt;Final Response Synthesizer &amp;amp; Grounded Attribution Engine&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:10px;color:#14532D;'&gt;• Compiles Sub-Agent Artifacts into Unified Executable Response&lt;br/&gt;• Attaches Verifiable Source Citations &amp;amp; Provenance Metadata&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#DCFCE7;strokeColor=#16A34A;strokeWidth=2;fontColor=#0F172A;align=left;spacingLeft=14;spacingTop=6;" vertex="1" parent="1">
          <mxGeometry x="1425" y="340" width="390" height="135" as="geometry" />
        </mxCell>

        <mxCell id="c4_telemetry" value="&lt;b style='font-size:12px;color:#0F172A;'&gt;Distributed Logging &amp;amp; Trace Observability Engine&lt;/b&gt;&lt;br/&gt;&lt;span style='font-size:10px;color:#1E293B;'&gt;• End-to-End Distributed Tracing across Agent Graph Transitions&lt;br/&gt;• Real-Time Token Cost ($), Latency (ms) &amp;amp; Grounding Support Index&lt;/span&gt;" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#FFFFFF;strokeColor=#0284C7;strokeWidth=2;fontColor=#0F172A;align=left;spacingLeft=14;spacingTop=6;" vertex="1" parent="1">
        ...
        <mxCell id="e_sup_to_state" value="Checkpoint Run Object State" style="edgeStyle=orthogonalEdgeStyle;rounded=1;orthogonalLoop=1;jettySize=auto;html=1;strokeColor=#0284C7;strokeWidth=3;fontColor=#0284C7;fontStyle=1;fontSize=10;labelBackgroundColor=#FFFFFF;" edge="1" parent="1" source="c1_supervisor" target="c1_state">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>

        <!-- Inter-Column Flow 1: Master Supervisor -> Worker Cluster -->
        <mxCell id="e_sup_to_workers" value="handoff_to_agent() ➔" style="edgeStyle=orthogonalEdgeStyle;rounded=1;orthogonalLoop=1;jettySize=auto;html=1;strokeColor=#0284C7;strokeWidth=3;exitX=1;exitY=0.5;entryX=0;entryY=0.5;fontColor=#0284C7;fontStyle=1;fontSize=11;labelBackgroundColor=#FFFFFF;" edge="1" parent="1" source="c1_supervisor" target="w_code">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
        ...
        <mxCell id="e_consensus_to_sandbox" value="Parallel Code Kernel ➔" style="edgeStyle=orthogonalEdgeStyle;rounded=1;orthogonalLoop=1;jettySize=auto;html=1;strokeColor=#16A34A;strokeWidth=3;exitX=1;exitY=0.5;entryX=0;entryY=0.5;fontColor=#14532D;fontStyle=1;fontSize=11;labelBackgroundColor=#FFFFFF;" edge="1" parent="1" source="consensus_hub" target="c3_sandbox">
          <mxGeometry relative="1" as="geometry">
            <Array as="points">
              <mxPoint x="920" y="657" />
              <mxPoint x="920" y="247" />
        ...
        <mxCell id="e_hitl_to_synth" value="submit_tool_outputs Signature" style="edgeStyle=orthogonalEdgeStyle;rounded=1;orthogonalLoop=1;jettySize=auto;html=1;strokeColor=#16A34A;strokeWidth=3;" edge="1" parent="1" source="c4_interrupt" target="c4_synthesis">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
