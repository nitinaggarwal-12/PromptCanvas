...
export function generateGCPFunctionalFlowchart(props: GCPFlowchartProps = {}): string {
  ...
  const ICONS = {
    ...
    deepmindGemini: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M12 2L14.5 9.5L22 12L14.5 14.5L12 22L9.5 14.5L2 12L9.5 9.5L12 2Z" fill="url(#gemini_grad_f)"/><defs><linearGradient id="gemini_grad_f" x1="2" y1="2" x2="22" y2="22" gradientUnits="userSpaceOnUse"><stop stop-color="#1A73E8"/><stop offset="0.5" stop-color="#9333EA"/><stop offset="1" stop-color="#EA4335"/></linearGradient></defs></svg>`,
  ...
  // =========================================================================
  // 1. GLOBAL REGION & GOOGLE CLOUD PROJECT FRAMES
  // =========================================================================
  // GLOBAL REGION Outer Frame
  cell(
    'global_region_frame',
  ...
  // Left Legend Box (Full 2-Part Replication)
  cell(
    'legend_box',
  ...
  // Bottom-Left Stacked Cross-Cutting Enablers (Ground-Truth Position)
  cell(
    'cloud_monitoring_box',
    `<div style="display:flex;align-items:center;gap:6px;padding:3px 6px;">
      ${ICONS.monitoringPulse}
      <div>
        <div style="font-size:7.5px;font-weight:900;color:#0F172A;">CLOUD MONITORING</div>
  ...
  // =========================================================================
  // ZONE 2: LOAD BALANCING & COMPUTE (x=455..725)
  // =========================================================================
  cell(
    'zone_compute_frame',
  ...
  cell(
    ...
    `<div style="display:flex;align-items:center;gap:6px;padding:3px 6px;">
      ...
      <div>
        ...
        <div style="font-size:6.5px;color:#0284C7;font-weight:600;">(via Firebase Auth)</div>
      </div>
    </div>`,
    478,
    185,
  ...
  cell(
    ...
    `<div style="text-align:center;padding:3px;">
      ${ICONS.loadBalancer}
      <div style="font-size:7.5px;font-weight:900;color:#0F172A;line-height:1.2;margin-top:2px;">REGIONAL<br/>INTERNAL LOAD<br/>BALANCER</div>
    </div>`,
    598,
    580,
    100,
  ...
  // =========================================================================
  // ZONE 3: APPLICATION & DATA (x=735..1005)
  // =========================================================================
  cell(
    'zone_data_frame',
  ...
  cell(
    ...
    `<div style="text-align:center;padding:3px;">
      ${ICONS.lifecycle}
      <div style="font-size:7.5px;font-weight:900;color:#0F172A;line-height:1.1;margin-top:2px;">DATA LIFE CYCLE<br/>MANAGEMENT</div>
  ...
  cell(
    ...
    `<div style="text-align:center;padding:3px;">
      ${ICONS.predictionZap}
      <div style="font-size:7.5px;font-weight:900;color:#0F172A;margin-top:2px;">ONLINE PREDICTION</div>
  ...
  edge('e10', '⓲', 'decision_con_bottom', 'gce_mig_box', 'edgeStyle=orthogonalEdgeStyle;rounded=1;strokeColor=#0284C7;strokeWidth=2.5;labelBackgroundColor=#FFFFFF;labelBorderColor=#CBD5E1;padding=2;fontSize=8;fontStyle=1;', [{ x: 440, y: 662 }, { x: 440, y: 620 }]);
