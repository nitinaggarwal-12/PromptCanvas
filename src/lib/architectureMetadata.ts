...
export const ARCHITECTURE_METADATA_MAP: Record<string, ArchitectureMeta> = {
  tech_fintech_payments: {
    ...
    desc: "Google Cloud Architecture: Fintech Use Case - Automated Personalized Financial Advising and Relationship Management with AI Financial Assistant & Gemini Platform."
  },
  ...
  tech_supply_chain: {
    ...
    title: "Equipment Optimization & Industrial AI Agents (Manufacturing)",
    category: "Industry Specialized Solutions",
    useCase: "MANUFACTURING USE CASE: EQUIPMENT OPTIMIZATION & INDUSTRIAL AI AGENTS",
    businessUseCase: "Google Cloud Manufacturing Solution: Industrial equipment optimization and autonomous Gemini AI agents integrating industrial equipment telemetry, Manufacturing Data Engine (MDE), Vertex AI Orchestration, Gemini Multimodal Anomaly Detection, Gemini Predictive Maintenance Reasoning Agent, Looker Operational Cockpit, and closed-loop actionable buttons.",
    ...
    desc: "Google Cloud Manufacturing Use Case: Equipment Optimization & Gemini AI Agents with Manufacturing Data Engine, Multi-Modal Anomaly Detection & Closed-Loop Actions."
  },
  tech_eval_safety: {
    id: "tech_eval_safety",
    title: "Agentic AI Evaluation, Safety & Optimization Platform",
    category: "AI & Cognitive Systems",
    useCase: "AGENTIC AI EVALUATION, SAFETY & OPTIMIZATION PLATFORM",
    businessUseCase: "Closed-loop Agentic AI Evaluation, Safety, and Optimization Platform integrating Agent Registry, Vertex AI Agent Builder, Gemini 3.7 Flash intelligence core, GKE/Cloud Run agent workloads, parallel AI-based & Human-in-the-loop evaluation, Safety Guardrails, BigQuery/Looker optimization analytics, and continuous ML-driven closed-loop updates.",
    ...
    desc: "GCP Solution Blueprint: End-to-End Agentic AI Evaluation, Safety, and Optimization Platform powered by Google Cloud, Gemini Platform, Agent Registry, and Enterprise Context."
  },
  tech_agentic_mesh: {
    id: "tech_agentic_mesh",
    title: "Hybrid Multi-Cloud Networking & Gemini Enterprise",
    category: "Cloud Infrastructure & Networking",
    useCase: "HYBRID MULTI-CLOUD NETWORKING & GEMINI ENTERPRISE",
    businessUseCase: "Production-grade Google Cloud reference architecture for Hybrid Multi-Cloud Networking featuring 100G Dedicated Interconnect, Partner Interconnect, Cloud VPN, Cross-Cloud Interconnect for AWS, Network Connectivity Center (NCC) hub-and-spoke BGP routing, and Gemini Enterprise AI Operations.",
  ...
  tech_serverless_gcp: {
    ...
    title: "Serverless Event-Driven Architecture (GCP)",
    category: "Cloud Infrastructure & Networking",
    useCase: "SERVERLESS EVENT-DRIVEN ARCHITECTURE (EDA)",
    businessUseCase: "Production serverless Event-Driven Architecture (EDA) integrating Enterprise mobile clients and IoT Industrial Sensors with Cloud Load Balancing, Cloud Run Ingestion microservice, distributed Pub/Sub asynchronous event bus, Vertex AI Platform (Predictive Maintenance & Root Cause Analysis), Cloud Bigtable time-series data, Cloud SQL metadata, BigQuery data analytics lake, Looker visual insights, BigQuery ML, and automated external API actions via Cloud Tasks and Notification Services.",
    ...
    desc: "Serverless Event-Driven Architecture (EDA) blueprint mapping mobile/IoT ingress, Cloud Run ingestion, Pub/Sub messaging bus, Gemini Platform reasoning, Cloud Bigtable, BigQuery, Looker reporting, and automated Cloud Tasks actions."
  },
  ...
  six_rs_migration_matrix: {
    ...
    desc: "6Rs Migration Disposition Matrix mapping legacy workloads across multi-tier assessment logic into Rehost, Replatform, Refactor, Retain, Retire, and Repurchase cloud destinations."
  },
  tech_6rs_migration: {
    id: "six_rs_migration_matrix",
    title: "6Rs Migration Disposition Matrix (Assessment Phase)",
    category: "Legacy Discovery",
    useCase: "6RS MIGRATION DISPOSITION MATRIX",
    businessUseCase: "Enterprise Cloud Migration Assessment & 6Rs Disposition Framework evaluating Legacy Components across Business Value, Technical Feasibility, and Cloud Compatibility decision tracks into Rehost, Replatform, Refactor, Retain, Retire, and Repurchase target dispositions.",
    primaryActors: "Cloud Infrastructure Leads, Data Architects, C-Suite, PMO, Migration Teams",
    targetOutcomes: "Prioritized Application Disposition Inventory, Clear 6Rs Migration Roadmap, Quantified Cloud TCO Savings, Zero Cloud Migration Regressions",
    desc: "6Rs Migration Disposition Matrix mapping legacy workloads into Rehost, Replatform, Refactor, Retain, Retire, and Repurchase cloud destinations."
  },
  hybrid_strangler_transition: {
    ...
    desc: "Hybrid Strangler Fig transition architecture with Apigee API Gateway request routing, Secure Cloud Interconnect, Site-to-Site VPN, and parallel on-premise to GCP modern microservice execution."
  },
  tech_hybrid_strangler: {
    ...
    category: "Legacy Discovery",
    useCase: "HYBRID / STRANGLER FIG TRANSITION ARCHITECTURE",
    businessUseCase: "Enterprise Hybrid Cloud & Strangler Fig Transition Architecture connecting On-Premises Datacenter legacy systems with Google Cloud Platform VPC via Secure Cloud Interconnect and Site-to-Site VPN with Apigee API Gateway routing.",
    primaryActors: "Cloud Enterprise Architects, Network Engineers, SRE Leads, Backend Engineers, Security Officers",
    targetOutcomes: "Zero-Downtime Gradual Migration, 100% SLA Business Continuity, SOC 2 & HIPAA Regulatory Assurance, Phased Monolith Decommissioning",
    desc: "Hybrid Strangler Fig transition architecture with Apigee API Gateway request routing, Secure Cloud Interconnect, and modern microservices."
  },
  cloud_finops_chargeback: {
    ...
    useCase: "CLOUD FINOPS & CHARGEBACK MODEL",
    ...
    desc: "Cloud FinOps & Chargeback model mapping usage tracking, BigQuery cost data lake, Vertex AI token pricing, Looker Studio reporting, and automated showback/chargeback generation."
  },
  tech_cloud_finops: {
    id: "cloud_finops_chargeback",
    title: "Cloud FinOps & Chargeback Model (FinOps & Economics Category)",
    category: "FinOps & Economics",
    useCase: "CLOUD FINOPS & CHARGEBACK MODEL",
    businessUseCase: "Enterprise Cloud FinOps, Cost Optimization & Automated Chargeback Framework connecting Ingestion & Usage Tracking with Data Aggregation & Cost Allocation into Unified BigQuery Cost Data Lake, Looker Studio dashboards, and FinOps Governance.",
    ...
    desc: "Cloud FinOps & Chargeback model with BigQuery cost data lake, Vertex AI token tracking, Looker Studio dashboards, and showback generator."
  },
  ai_coe_operating_model: {
    ...
    useCase: "AI CENTER OF EXCELLENCE (COE) OPERATING MODEL",
    businessUseCase: "Enterprise AI Center of Excellence (CoE) Operating Model establishing cross-functional Governance & Strategy (Adoption Modeling, Business Plan ideation, Cloud Plans alignment), Process & Operations (User Onboarding, Prompt Curation, Continuous Feedback Loops with Jira/Confluence integration), and Analytics & Measurement (Performance Metrics, Utilization Insights via Looker). Enforces GAMP 5 Compliance Framework validation, delivers the certified AI CoE Operating Model artifact into Total Unified System View (Enterprise Platform Context & 24/7 Operations Support), and secures recurring quarterly Funding through closed-loop executive review and approval with Business Leads.",
    primaryActors: "Head of AI / AI CoE Leads, Chief Strategy Officer, VP of Engineering, GAMP 5 Compliance Officers, Business Unit Leads, SRE / Operations Leads",
    ...
    desc: "AI Center of Excellence operating model framework mapping governance, continuous user onboarding & prompt curation loops, Looker analytics, GAMP 5 compliance, and executive funding loops."
  },
  tech_ai_coe: {
    id: "ai_coe_operating_model",
    title: "AI Center of Excellence (CoE) Operating Model (Operational Excellence Category)",
    category: "Operational Excellence",
    useCase: "AI CENTER OF EXCELLENCE (COE) OPERATING MODEL",
    businessUseCase: "Enterprise AI Center of Excellence (CoE) Operating Model establishing cross-functional Governance & Strategy, Process & Operations (User Onboarding, Prompt Curation, Feedback Loops), and Analytics & Measurement under GAMP 5 validation and executive funding approval.",
  ...
  mcp_context_gateway: {
    ...
    desc: "Model Context Protocol Gateway blueprint mapping multi-source context ingestion, normalized MCP message bus, tool proxies, and actionable tool integration."
  },
  tech_mcp_gateway: {
    id: "mcp_context_gateway",
    title: "Model Context Protocol Gateway (MCP Context Gateway) (Operational Excellence Category)",
    category: "Operational Excellence",
    useCase: "MODEL CONTEXT PROTOCOL (MCP) GATEWAY",
    businessUseCase: "Enterprise Model Context Protocol (MCP) Gateway architecture connecting multi-source context adapters, MCP Schema Message Bus, and Tool Proxies to downstream actionable tool systems and Looker analytics.",
    ...
    desc: "Model Context Protocol Gateway blueprint mapping context ingestion adapters, MCP message bus, and downstream tool proxies."
  },
  logical_ai_config_tenant: {
    ...
    businessUseCase: "Product Plan: Multi-tenant Logical AI Configuration architecture for Enterprise AI Platform within Gemini Enterprise. Enforces Environment Segregation across Development, Testing, and Production environments via Enterprise IAM, Logical AI Config Console, and APIs. Production workspaces encapsulate Logical AI Config (Model Selection Gemini 3.7 Flash, System Instructions, Memory & Context Management, Tool Invocation Definitions) and Agent Designer (Single-Agent, Multi-Agent Chains, Task-Based Sub-Agents) with strict SOC 2 and GxP Compliance Guardrails, VPC Firewalls, Centralized Audit Logging, and KMS Configuration Encryption.",
  ...
  hub_and_spoke_agent_config: {
    ...
    title: "Hub-and-Spoke Agent Configuration Map (Logical AI Config Category)",
    category: "Operational Excellence",
    useCase: "HUB-AND-SPOKE AGENT CONFIGURATION MAP",
    businessUseCase: "Enterprise Hub-and-Spoke Multi-Agent Configuration Map within Gemini Enterprise and Agent Designer. Orchestrator Parent Agent Hub manages General Configuration (Gemini 3.7 Flash, Global System Instructions, Shared Context Window, Memory TTL), Multi-Agent Router / Dispatcher Logic with intent-based rule routing, Shared Memory & State, Vertex AI Agent Runtime, and 21 CFR Part 11 Compliance Gate. Dispatches to 3 specialized Sub-Agents (Customer Support with Zendesk API & BigQuery/Vector Grounding, Fulfillment SA with SAP ERP API & Cloud Storage, and Knowledge SA with GCS PDF/Doc Grounding). Features Logical UI Configuration Matrix (Prompt editors, Rule editors, Knowledge Source selectors, API Config panels), Human-in-the-Loop (HITL) Gate, 21 CFR Part 11 Immutable Audit Trail & E-Signature Ledger, and Persona Dashboards (AI Architect, Solutions Architect, Agent Economic & Runtime Metrics).",
    primaryActors: "AI Architects, Solutions Architects, Agent Developers, 21 CFR Part 11 Compliance Officers, Support Engineers",
    ...
    desc: "Hub-and-Spoke agent configuration blueprint mapping Orchestrator parent agent, specialized domain sub-agents, Logical UI config matrix, HITL gate, and 21 CFR Part 11 audit ledger."
  },
  tech_hub_spoke_agent: {
    id: "hub_and_spoke_agent_config",
    title: "Hub-and-Spoke Agent Configuration Map",
    category: "Operational Excellence",
    useCase: "HUB-AND-SPOKE AGENT CONFIGURATION MAP",
  ...
  unified_data_governance: {
    ...
    desc: "Unified Data Governance blueprint mapping Collibra strategy, Dataplex active control plane, ABAC enforcement across Modern Data Stack, and compliance scorecards."
  },
  tech_unified_data_governance: {
    id: "unified_data_governance",
    title: "Unified Data Governance & Access Control",
    category: "Security & Governance",
    useCase: "UNIFIED DATA GOVERNANCE & ACCESS CONTROL",
  ...
  dataops_anomaly_detection: {
    ...
    desc: "DataOps blueprint mapping Looker observability, SRE incident integration, Dataplex SODA/CARLO anomaly detection, and hallucination-free Vertex AI grounding."
  },
  tech_dataops_anomaly: {
    id: "dataops_anomaly_detection",
    title: "DataOps & Anomaly Detection",
    category: "Modern Data Stack",
    useCase: "DATAOPS & ANOMALY DETECTION ARCHITECTURE",
  ...
  golive_warroom_runbook: {
    ...
    desc: "Go-Live Cutover blueprint mapping preparation gates, war room Opsgenie integration, 5-step minute-by-minute cutover script, and automated rollback logic."
  },
  tech_golive_warroom: {
    id: "golive_warroom_runbook",
    title: "Go-Live Cutover & War Room Runbook",
    category: "Operational Excellence",
    useCase: "GO-LIVE CUTOVER & WAR ROOM RUNBOOK",
  ...
  enterprise_sre_observability: {
    ...
    title: "Enterprise SRE Observability & Incident Triage",
    category: "Operational Excellence",
    useCase: "ENTERPRISE SRE OBSERVABILITY & INCIDENT TRIAGE",
  ...
  tech_llm_capacity_quota: {
    ...
    title: "LLM Capacity & Quota Management",
    category: "AI & Machine Learning",
    useCase: "COMPREHENSIVE TOPOLOGY FOR (LLM) CAPACITY QUOTA MANAGEMENT",
  ...
  tech_multimodal_ingestion: {
    ...
    title: "Agentic Multi-Modal Ingestion Flow",
    category: "Data & AI Architecture",
    useCase: "GOOGLE CLOUD END-TO-END ARCHITECTURE: AGENTIC MULTI-MODAL INGESTION FLOW",
    businessUseCase: "Google Cloud End-to-End Architecture: Agentic Multi-Modal Ingestion Flow powered by Gemini Platform and Enterprise Client Applications: Multi-Modal Input Sources (User Application Custom Client, Enterprise Mobile App, 4 channels: Text/Docs, Voice/Audio, Image/Video, Geo-Spatial), Capture & Multi-Modal Processing GCP Services (Cloud Storage GCS, Speech-to-Text API, Vertex AI Vision API & Video Intelligence API, Google Maps Platform APIs), Gemini-Powered Agentic Orchestrator (Orchestration Agent powered by Gemini 3.7 Flash, Planning & Reasoning, Function Calling Tooling, Vertex AI Embedding API, Vertex AI Vector Search, Multimodal Semantic Search, Multimodal Gemini Reasoning Engine), and Knowledge Representation & Actions (BigQuery Knowledge Base, Knowledge Graph Storage, Automated Insights & Reports, Alerting & Notifications Cloud Functions, Map Annotations & Visualizations) with Platform Governance & Monitoring (IAM, Vertex AI Model Monitoring, Cloud Logging).",
    ...
    desc: "Agentic multi-modal ingestion flow blueprint mapping Custom Clients, Enterprise Mobile App, multi-modal GCP processing APIs, Gemini Agentic Orchestrator, BigQuery Knowledge Base, and automated alerting."
  },
  data_residency_sovereign_map: {
    id: "data_residency_sovereign_map",
    title: "Data Residency & Sovereign Cloud Map (To-Be State, Infra Provisioning Phase)",
    category: "Security & Governance",
    useCase: "DATA RESIDENCY & SOVEREIGN CLOUD MAP",
    businessUseCase: "Enterprise Data Residency and Sovereign Cloud Map establishing isolated regional boundaries across EU-West4 (The Netherlands) and US-Central1 (Iowa) with VPC Service Controls (VPC SC) perimeters, restricted GCP APIs, and Vertex AI local inference & grounding. Features cross-border GCP VPC-SC bridge data transfer paths, red alert perimeter tripwires, Looker Studio compliance dashboards (Compliance Score 99.8%, cross-border audit logs, grounding lineage), personas (Legal, CISO, SRE Ops Lead), and async management plane (Unified Trace Correlation, Vertex AI monitoring, Dataplex, Cloud Logging) enforcing GDPR, EU AI Act, and HIPAA regulatory guarantees.",
    ...
    desc: "Data Residency blueprint mapping multi-region sovereign boundaries, VPC Service Controls perimeters, cross-border transfer bridges, and Looker Studio compliance reporting."
  },
  tech_data_residency: {
    id: "data_residency_sovereign_map",
    title: "Data Residency & Sovereign Cloud Map",
    category: "Security & Governance",
    useCase: "DATA RESIDENCY & SOVEREIGN CLOUD MAP",
  ...
  tech_ai_trism_guardrails: {
    ...
    desc: "AI TRiSM Guardrail blueprint mapping input/output security filters, Cloud DLP masking, TRiSM threat engine, Looker observability, and EU AI Act compliance."
  },
  ai_trism_guardrails: {
    id: "tech_ai_trism_guardrails",
    title: "AI TRiSM Security Guardrail Pipeline",
    category: "Security & Governance",
    useCase: "AI TRISM SECURITY GUARDRAIL PIPELINE SYSTEM",
  ...
  tech_micro_frontends: {
    ...
    desc: "Micro-Frontend blueprint mapping Host App container, CDN bundles, MFE runtime orchestrator, WebSocket chat widgets, GraphQL APIs, and IdP token exchange."
  },
  micro_frontends_ui: {
    id: "tech_micro_frontends",
    title: "Micro-Frontend & UI Architecture",
    category: "Client & Presentation",
    useCase: "MICRO-FRONTEND & UI ARCHITECTURE",
