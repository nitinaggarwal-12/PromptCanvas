  ...
  return (
    <div className={`flex h-screen w-screen font-sans overflow-hidden select-none transition-colors duration-300 ${
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden relative">
        ...
        {/* Top Navbar */}
        <header className="h-14 border-b flex items-center justify-between px-4 md:px-8 backdrop-blur-md gap-3 shrink-0 z-30 bg-[#0B111E] border-slate-800 text-white shadow-md">
          {/* Breadcrumbs */}
